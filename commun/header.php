    ...
    <header id="bandeau">
        ...
        <div id="bandeau-principal">
            ...
            <nav id="hamburger-menu">
                ...
                <ul class="menu_box">
                    <li class="menu_item"><a class="two-lines" href="index.php">Accueil</a></li>
                    ...
                    <li class="menu_item"><a class="two-lines" href="contact_Ty-Joss.php">Contact</a></li>
                </ul>


            </nav>
        </div>
        <div id="imagePresentation"></div>
    </header>